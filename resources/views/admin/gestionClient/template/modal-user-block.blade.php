<div class="text-center my-2 d-flex justify-content-sm-center justify-content-md-start">
    <button type="button" id="btnCloseTicket" class="btn-scale btn btn-link text-primary p-0 pb-4 text-decoration-none"
        data-bs-toggle="modal" data-bs-target="#blockClientModal">Bloquer le compte du client</button>
</div>
<div class="modal fade" id="blockClientModal" tabindex="-1" aria-labelledby="blockClientModal" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered m-auto px-2">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Bloquer du compte client
                </h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body d-flex flex-column align-items-center">
                <p class="fs-5 fw-bold text-center"> BLOQUER LE COMPTE</p>
