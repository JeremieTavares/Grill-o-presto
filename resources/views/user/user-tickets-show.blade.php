...
@section('content')
    ...
    <main class="m-auto">
        ...
        <div class="container mw-900px">
            ...
            <div class="mt-md-5 mt-3 overflow-auto" id="divMsg">
            ...
            <form action="{{ route('user.tickets.message.submit', $user) }}" method="POST">
                ...
                <div class="d-flex justify-content-center">
                    ...
                    <button type="submit" class="btn btn-success btn-scale-press btn-rounded my-5 w-75" id="btnSubmitMessage">Envoyer</button>
                </div>
            </form>
        @else
            ...
            <div class="text-center my-5">
                <button type="button" id="btnCloseTicket" class="btn btn-primary btn-rounded btn-scale-press w-75" data-bs-toggle="modal" data-bs-target="#closeTicketModal">
                    Annuler ce ticket
                </button>
            </div>
                    ...
                    <div class="modal-dialog modal-dialog-centered m-auto">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title">Fermer le ticket: #{{ $ticketMessages[0]->ticket->ticket_number }}
                                </h5>
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary btn-scale-press" data-bs-dismiss="modal">Annuler</button>
                                ...
                                <form action="{{ route('user.tickets.patch', $ticketMessages[0]->ticket->id) }}"
                                    ...
                                    <button type="submit" class="btn btn-primary btn-scale-press" id="btnCloseModalYes">Supprimé</button>
                                </form>
                            </div>
                        </div>
                    </div>
