    ...
    <section class="offer_section">
        <div class="d-flex">
            ...
            <div class="text_container w-50">
                ...
                <ul class="p-0">                 
                    <a href="{{ route('menu', "classic") }}" class="text-decoration-none"><li class="text-secondary">Menu regulier <i class="fa-solid fa-circle-arrow-right text-primary btn-scale-press"></i></li></a>
                    <a href="{{ route('menu', "vegetarian") }}" class="text-decoration-none"><li class="text-secondary">Menu Vegetarien <i class="fa-solid fa-circle-arrow-right text-primary btn-scale-press"></i></li></a>
                    <a href="{{ route('menu', "gluten-free") }}" class="text-decoration-none"><li class="text-secondary">Menu sans-Gluten <i class="fa-solid fa-circle-arrow-right text-primary btn-scale-press"></i></li></a>
