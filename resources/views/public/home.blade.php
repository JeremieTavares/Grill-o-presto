...
@include('public.template.navbar')
    ...
    <main class="home d-flex flex-column">
            ...
            <div class="d-flex engage_container">
                <div class="d-flex flex-column">
                    ...
                    <div class="d-flex flex-column flex-xl-row align-items-center align-items-xl-start">
                        ...
                        <p>Du nouveau à chaque semaine : des produits d’épicerie de base et des repas préparés. Le tout moins dispendieux qu’à l’épicerie et pour tous les goûts.</p>
                    </div>
                </div>
                <div class="d-flex flex-column">
                    ...
                    <div class="d-flex flex-column flex-xl-row align-items-center align-items-xl-start">
                        ...
                        <p>Selon la région où vous vous situez, nous nous engageons à vous offrir une livraison rapide et efficace pour satisfaire tous nos clients.</p>
                    </div>
                </div>
                <div class="d-flex flex-column">
                    ...
                    <div class="d-flex flex-column flex-xl-row align-items-center align-items-xl-start">
                        ...
                        <p>Il n’y a aucun frais de livraison en bas de 60km. Au dessus de 60km, des frais de livraison seront facturés.</p>
                    </div>
                </div>
            </div>
        </section>
        <section class="wave_middle_section">
            ...
            <svg class="svg_top_wave"id="svg" viewBox="0 0 1440 399" xmlns="http://www.w3.org/2000/svg" class="transition duration-300 ease-in-out delay-150"><path d="M 0,400 C 0,400 0,200 0,200 C 78.39299209893508,210.91377533493645 156.78598419787016,221.8275506698729 232,220 C 307.21401580212984,218.1724493301271 379.2490553074545,203.60357265544485 443,193 C 506.7509446925455,182.39642734455515 562.217794572312,175.75815870834765 618,191 C 673.782205427688,206.24184129165235 729.8797664032977,243.36379251116455 810,244 C 890.1202335967023,244.63620748883545 994.2631398144968,208.78667124699416 1059,178 C 1123.7368601855032,147.21332875300584 1149.067674338715,121.48952250085881 1206,126 C 1262.932325661285,130.5104774991412 1351.4661628306426,165.2552387495706 1440,200 C 1440,200 1440,400 1440,400 Z" stroke="none" stroke-width="0" fill="#b40500" fill-opacity="1" class="transition-all duration-300 ease-in-out delay-150 path-0"></path></svg>
            <div class=" bg-primary d-flex justify-content-end div_home_page_middlewave">
                <p class="text-white">Chaque semaine, notre équipe crée une variété de recettes uniques et savoureuses, s’inspirant d’ingrédients frais et des nouveaux arrivages.</p>
            </div>
            <svg class="svg_bottom_wave" id="svg" viewBox="0 0 1440 399" xmlns="http://www.w3.org/2000/svg" class="transition duration-300 ease-in-out delay-150"><path d="M 0,400 C 0,400 0,200 0,200 C 77.46753692889041,225.98007557540365 154.93507385778082,251.96015115080726 215,244 C 275.0649261422192,236.03984884919274 317.7272414977671,194.13947097217454 388,198 C 458.2727585022329,201.86052902782546 556.1559601511509,251.4819649604947 637,236 C 717.8440398488491,220.5180350395053 781.6489178976296,139.93266918584675 837,142 C 892.3510821023704,144.06733081415325 939.2483682583304,228.78735829611819 1008,239 C 1076.7516317416696,249.21264170388181 1167.3576090690485,184.9178976296805 1243,166 C 1318.6423909309515,147.0821023703195 1379.3211954654757,173.54105118515974 1440,200 C 1440,200 1440,400 1440,400 Z" stroke="none" stroke-width="0" fill="#b40500" fill-opacity="1" class="transition-all duration-300 ease-in-out delay-150 path-0" transform="rotate(-180 720 200)"></path></svg>
        </section>
